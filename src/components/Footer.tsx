      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center">
          ...
          <div className="flex justify-center gap-3">
            ...
            {/* Google+ */}
            <a href="#" aria-label="Google Plus" className="w-8 h-8 rounded-full bg-gold-500 flex items-center justify-center text-white hover:bg-gold-400 transition-all hover:-translate-y-1">
              <span className="font-bold text-[13px]">G+</span>
            </a>
            {/* Twitter */}
            <a href="#" aria-label="Twitter" className="w-8 h-8 rounded-full bg-gold-500 flex items-center justify-center text-white hover:bg-gold-400 transition-all hover:-translate-y-1">
              <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="currentColor" stroke="none">
